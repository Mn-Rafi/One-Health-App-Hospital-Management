...
class GetAllDoctorsServices {
  ...
  Future<List<DoctorResponseModel>?> getAllDoctorsForSearch() async {
    log('sakfhksdfhkjdsh');
    List<DoctorResponseModel> doctorResponseModel;
    Dio dio = Dio();
    ...
    if (response.statusCode == 200) {
      log(response.toString());
      doctorResponseModel = (response.data as List)
          .map((i) => DoctorResponseModel.fromJson(i))
          .toList();
